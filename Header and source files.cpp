...
int main()
{
    int myBalanceTransaction = confirmAmount;
    int hackedBalanceTransaction = confirmAmount2;
    int myBalance = 150;
    ...
    cout << "myBalance- There is 150 in the account now how Much would you like to transfer: " "\n";
    cin >> b;
    cout << "\nBalance after transaction is: " << sumOfTwoNumbers(a, b) << endl;
    cout << "If the transaction above is correct enter the same number as confirmation: ";
        cin >> confirmAmount;
    cout << "hackedBalance:There is 1000 in the account now how Much would you like to transfer: " "\n";
    cin >> d;
    cout << "\nBalance after transaction is: " << sumOfTwoNumbers2(c, d) << endl;
    cout << "If the transaction above is correct enter the same number as confirmation: ";
    cin >> confirmAmount2;
